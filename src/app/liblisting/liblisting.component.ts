...
@Component({
  selector: 'app-liblisting',
  templateUrl: './liblisting.component.html',
  styleUrls: ['./liblisting.component.css']
})
export class LiblistingComponent implements OnInit {
  ...
  formdata: any = {
    ...
    fields: [
      ...
      {
        label: "Formating222 Phone Number 2",
        name: "phone_format_2",
        type: 'numberformat',
        value: "(877) 737-8152",
        hint: 'dddd',
