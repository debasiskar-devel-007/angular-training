...
export class ApiService {
  ...
  public domain: any = environment["API_URL"];
  ...
  postlogin(endpoint: any, data: any) {
  ...
  putData(endpoint: any, data: any, id: any) {
    const httpOptions = {
      headers: new HttpHeaders({
        'Content-Type': 'application/json',
        'Authorization': this.cookieService.get('jwttoken')
  ...
  public getSiteSettingData(url: any): Observable<any> {
